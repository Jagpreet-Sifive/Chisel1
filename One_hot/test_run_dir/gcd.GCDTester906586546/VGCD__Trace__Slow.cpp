...
void VGCD::traceInitThis__1(VGCD__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	// Tracing: GCD _T_17 // Ignored: Inlined leading underscore at GCD.v:14
	// Tracing: GCD _T_18 // Ignored: Inlined leading underscore at GCD.v:15
	// Tracing: GCD _T_19 // Ignored: Inlined leading underscore at GCD.v:16
	// Tracing: GCD _T_20 // Ignored: Inlined leading underscore at GCD.v:17
	// Tracing: GCD _T_21 // Ignored: Inlined leading underscore at GCD.v:18
	// Tracing: GCD _T_22 // Ignored: Inlined leading underscore at GCD.v:19
	// Tracing: GCD _T_23 // Ignored: Inlined leading underscore at GCD.v:20
	// Tracing: GCD _GEN_0 // Ignored: Inlined leading underscore at GCD.v:21
	// Tracing: GCD _GEN_1 // Ignored: Inlined leading underscore at GCD.v:22
    }
}
